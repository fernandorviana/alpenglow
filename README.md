...
| **Theme** | Light / Dark | 58 semantic tokens — `surface`, `text`, `interactive`, `border`. Every value is an alias. |
...
207 test cases covering what the design actually depends on: text clearing AA on
