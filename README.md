...
|---|---|---|
| **Primitives** | no | The raw ramps. 111 opaque colours — white and ten families of eleven stops, generated in OKLCH with one lightness per stop — plus 16 alpha values: twelve on the black and white ramps, three inks (two for shadows, one for the dark scrim) and the light scrim's mist. Nothing references these directly. |
...
123 test cases covering what the design actually depends on: text clearing AA on
